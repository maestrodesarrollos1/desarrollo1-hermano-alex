...
const galleryItems = [
  { src: "/couple-gallery/photo-1.jpg", title: "Mirada", note: "01 / Primeras luces", fallback: "linear-gradient(160deg, #6f374b, #d99fa6 54%, #fff3e9)" },
  { src: "/couple-gallery/photo-2.jpg", title: "Complices", note: "02 / Sin prisa", fallback: "linear-gradient(160deg, #5b3040, #bd7c8c 56%, #f4d5ca)" },
  { src: "/couple-gallery/photo-3.jpg", title: "Promesa", note: "03 / Un instante", fallback: "linear-gradient(160deg, #814356, #e6b2ad 52%, #fff5ed)" },
  { src: "/couple-gallery/photo-4.jpg", title: "Brindis", note: "04 / Por nosotros", fallback: "linear-gradient(160deg, #5b3040, #c58f79 53%, #f9ded0)" },
  { src: "/couple-gallery/photo-5.jpg", title: "Baile", note: "05 / La noche", fallback: "linear-gradient(160deg, #44222f, #9b5b6d 48%, #e9b5ab)" },
] as const;
