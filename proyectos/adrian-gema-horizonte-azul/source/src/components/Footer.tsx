...
export default function Footer() {
  return <footer className="az-footer" data-editor-component="footer">
    <div className="az-closing-photo"><img src={v.images.despedida} alt="Adrián y Gema con Nala en la montaña" loading="lazy" width="1200" height="900"/><div><p className="az-kicker">Lo siguiente, con vosotros.</p><p className="az-closing-title">Nos vemos<br/><em>en nuestra boda.</em></p></div></div>
