...
const galleryItems = [
  { src: templateValues.images.galeria1 || "/couple-gallery/photo-1.jpg", title: "Mirada", fallback: "linear-gradient(135deg, #123c2d, #628d70)" },
  { src: templateValues.images.galeria2 || "/couple-gallery/photo-2.jpg", title: "Brindis", fallback: "linear-gradient(135deg, #1e4c39, #d3bb83)" },
  { src: templateValues.images.galeria3 || "/couple-gallery/photo-3.jpg", title: "Baile", fallback: "linear-gradient(135deg, #081711, #3c7656)" },
  { src: templateValues.images.galeria4 || "/couple-gallery/photo-4.jpg", title: "Detalle", fallback: "linear-gradient(135deg, #315b47, #e8dfc8)" },
  { src: templateValues.images.galeria5 || "/couple-gallery/photo-5.jpg", title: "Noche", fallback: "linear-gradient(135deg, #06100b, #7a6332)" },
  { src: templateValues.images.galeria6 || "/couple-gallery/photo-6.jpg", title: "Promesa", fallback: "linear-gradient(135deg, #294d3a, #95b198)" },
] as const;
