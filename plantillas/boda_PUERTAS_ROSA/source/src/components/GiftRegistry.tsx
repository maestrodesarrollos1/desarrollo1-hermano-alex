...
const GiftRegistry = () => {
  return (
    <section id="regalos" data-editor-component="gifts" className="scroll-animate relative isolate overflow-hidden bg-[#4A2735] px-5 py-20 text-[#FFF9F3] md:px-8 md:py-28">
      <img src="/images/doors/rose-dinner-editorial.png" alt="Detalle de una mesa para la celebracion" className="absolute inset-0 -z-20 h-full w-full object-cover object-[70%_center] opacity-75" />
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(74,39,53,.96)_0%,rgba(74,39,53,.82)_44%,rgba(74,39,53,.38)_100%)]" />
