    ...
    <section id="confirmar-asistencia" data-editor-component="rsvp" className="scroll-animate bg-white px-5 py-16 md:py-24">
      <div className="mx-auto grid max-w-6xl overflow-hidden border border-[#DDECE0] bg-[#FBFEFB] shadow-[0_26px_76px_rgba(15,61,46,0.1)] lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="grid content-center gap-5 p-6 md:p-10">
          ...
          <a
            href={RSVP_FORM_URL}
            className="font-nav mt-2 inline-flex min-h-14 items-center justify-center gap-3 border border-[#A7605F] bg-[#A7605F] px-6 text-sm uppercase tracking-[0.26em] text-white transition hover:bg-[#0F3D2E] hover:border-[#0F3D2E]"
          >
            <CalendarCheck className="h-5 w-5" aria-hidden="true" />
            Confirmar asistencia
          </a>
          <p className="text-center text-sm italic text-[#7FAF8E]">Configura la fecha limite antes de publicar</p>
        </div>
      </div>
    </section>
  );
